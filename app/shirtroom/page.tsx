  ...
  return (
    <main style={{ backgroundColor: "black", minHeight: "100vh", padding: "20px" }}>
      <div style={{ maxWidth: "430px", margin: "0 auto", color: "white" }}>
        ...
        {[
          ["가게 위치는 어디인가요?", "저희는 마포점과 신촌점이 있습니다. 마포점은 마포역 3번 출구에서 약 30m, 신촌점은 신촌역 7번 출구에서 약 20m 거리에 있습니다."],
          ["가격, 시스템은 어떻게 되나요?", "저희 가게는 소주,맥주+안주 무제한+T.C를 원칙으로 구성 되어있습니다. 비 강남권에서 최저의 가격 + 최고의 비주얼을 자랑합니다.."],
          ["중간에 교체 가능한가요?", "물론 입니다. 더 좋은 선택이 있다면 가능합니다."],
          ["인사 있나요?", "네 저희는 인사가 기본적으로 포함되어 있으며, 한번 인사를 경험한 손님들은 높은 확률로 단골이 됩니다."],
